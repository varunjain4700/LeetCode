...
{
    public:
       	//JUST COPIED TO MAINTAIN THE STREAK :/
       	//NEEDS TO  BE SOLVED
    ...
    {
        checkIns[id] = { stationName,
            t
        };	// store id checked in at stationName at time t
    }
    ...
    void checkOut(int id, string stationName, int t)
    {
        ...
        routeTimings[startToEnd] = { routeTimings[startToEnd].first + (t - checkIns[id].second),
            routeTimings[startToEnd].second + 1
        };
